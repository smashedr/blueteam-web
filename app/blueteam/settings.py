...
BLUE_DISCORD_BOT_TOKEN = os.getenv('BLUE_DISCORD_BOT_TOKEN')
BLUE_DISCORD_BLUE_ROLE = os.getenv('BLUE_DISCORD_BLUE_ROLE')
BLUE_DISCORD_OFFICER_ROLE = os.getenv('BLUE_DISCORD_OFFICER_ROLE')
BLUE_DISCORD_ID = os.getenv('BLUE_DISCORD_ID')
